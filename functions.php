...
function planet_gaming_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('Product Footer'),
        'id' => 'product-footer',
        'before_widget' => '<div id="%1$s" class="%2$s col-lg-4">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="product-footer">',
        'after_title' => '</h2>',
        'description' => 'Product Footer Widget Area',
    ));
    register_sidebar(array(
        'name' => __('Onze Product Page'),
        'id' => 'onze-product-page',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title">',
        'after_title' => '</h2>',
        'description' => 'Onze Product Page Widget Area',
    ));
}
...
function planet_gaming_scripts()
{
    ...
    //wp_enqueue_style('planet-gaming-style', get_template_directory_uri() . '/assets/css/custom-style.css');
...
if (function_exists('acf_add_options_page')) {
    ...
    acf_add_options_page(array(
        'page_title' => 'Write Content',
        'menu_title' => 'Load Content',
        'menu_slug' => 'write_content',
...
function cptui_register_my_taxes()
{
    ...
    $labels = array(
        "name" => __("Product categories", "planet-gaming"),
        "singular_name" => __("product category", "planet-gaming"),
    );

    $args = array(
        "label" => __("Product categories", "planet-gaming"),
        "labels" => $labels,
        "public" => true,
    ...
    register_taxonomy("product_category", array("onze_producten"), $args);
}
